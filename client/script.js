...
const repeatMyParam = () => {
    ...
    // axios.get(`${baseUrl}repeat/some string`)
...
const getRequest = () => {
    axios.get(`http://localhost:3000/query-test?myquery=query-goes-here&another-query=more-queries`)
    .then(res => {
        console.log(res.data)
    })
    .catch(err => {
...
const query = document.getElementById('query-button').addEventListener('click', getRequest)
